...
Trains a 5-fold stratified cross-validation XGBoost model based on the
Kaggle notebook "pss6e4-lgb-baselinecv-0-97943" by yunsuxiaozi.
Uses digit-extraction feature engineering, target encoding, and sample
weighting.  Includes Optuna class-weight post-processing optimisation.
...
SAVE_DIR = "/media/oscarm524/Expansion/Kaggle/2026/PS_Ep4/Version_2/XGBoost"
OUTPUT_PATH = f"{SAVE_DIR}/xgb_1.csv"
OOF_PATH = f"{SAVE_DIR}/xgb_1_oof.csv"
TEST_PROBS_PATH = f"{SAVE_DIR}/xgb_1_test.csv"
...
for fold, (train_idx, valid_idx) in enumerate(skf.split(X, y)):
    ...
    # OOF predictions
    oof_probs[valid_idx] = model.predict_proba(X_valid_fold)
...
# Overall OOF Balanced Accuracy: 0.976702

# Running Optuna class-weight optimisation...
# Best trial: 185. Best value: 0.979951: 100%|█████████████████████████████████████████████████████████| 200/200 [00:05<00:00, 39.33it/s]

# Best Optuna Balanced Accuracy: 0.979951
#   cw_Low    = 0.6100
#   cw_Medium = 0.5033
#   cw_High   = 2.8950