"""CatBoost experiment 6 -- Deeper trees (depth=6) + lower learning rate.

Explores a deeper tree architecture with a smaller learning rate and
more iterations to allow the model to learn more complex patterns.
Uses the baseline feature set.
"""
...
OUTPUT_PATH = f"{SAVE_DIR}/cat_6.csv"
OOF_PATH = f"{SAVE_DIR}/cat_6_oof.csv"
TEST_PROBS_PATH = f"{SAVE_DIR}/cat_6_test.csv"
