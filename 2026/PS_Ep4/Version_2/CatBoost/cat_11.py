"""CatBoost experiment 11 -- 10-fold CV + best features + tuned HP.

Uses 10-fold cross-validation with the best combined feature set
(interactions + ratios + decimal digits + binary flags) and
carefully tuned hyperparameters for maximum balanced accuracy.
"""
...
OUTPUT_PATH = f"{SAVE_DIR}/cat_11.csv"
OOF_PATH = f"{SAVE_DIR}/cat_11_oof.csv"
TEST_PROBS_PATH = f"{SAVE_DIR}/cat_11_test.csv"
...
for fold, (tr_idx, va_idx) in enumerate(skf.split(X, y)):
    ...
    test_preds += model.predict_proba(ep) / N_FOLDS
