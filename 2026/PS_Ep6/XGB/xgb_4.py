...
OUTPUT_PATH = f"/media/oscarm524/Expansion/Kaggle/2026/PS_Ep6/MODELING_V1/XGB/xgb_4.csv"
...
param = {
    ...
    "num_class": 3,
    "max_depth": 7,
    "learning_rate": 0.023878037782930524,
    "subsample": 0.7892163428996646,
    "colsample_bytree": 0.887402358543856,
    "random_state": 42,
}
...
OOF_PATH = f"/media/oscarm524/Expansion/Kaggle/2026/PS_Ep6/MODELING_V1/XGB/xgb_4_oof.csv"
oof_df = pd.DataFrame({
    "id": X.index,
...
# Best Optuna Balanced Accuracy: 0.965725
#   cw_GALAXY    = 2.3517
#   cw_QSO = 2.7280
#   cw_STAR   = 2.7370