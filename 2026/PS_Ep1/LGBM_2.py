...
lgb_params = {
 'learning_rate': 0.09066181426290201,
 'max_depth': 5,
 'reg_alpha': 0.02973421418700197,
 'reg_lambda': 2.260451658634028,
 'num_leaves': 20,
 'colsample_bytree': 0.7901487502240994,
 'verbose': -1,
 'n_jobs': -1,
 'device': 'gpu'
 }
...
preds_per_fold = [df["lgb_pred_2"].values for df in test_preds_df]
...
submission.to_csv("lgb_sub_2.csv", index=False)

print("Saving OOF predictions...")
oof_preds_df = pd.concat(oof_preds_df)
oof_preds_df.to_csv("oof_lgb_2.csv", index=False)

print("Saving test predictions...")
test_preds_df = pd.concat(test_preds_df)
test_preds_df.to_csv("test_lgb_2.csv", index=False)
print("Done!")