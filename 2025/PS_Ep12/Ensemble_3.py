...
submission.to_csv("ens_sub_3.csv", index=False)
print("Ensemble submission saved as ens_sub_3.csv")
print("Done!")

# Logistic OOF AUC: 0.730439901313414
# LDA OOF AUC: 0.7304364362096998
# Voting OOF AUC: 0.7304395638112137
